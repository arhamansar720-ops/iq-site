...
export default function Hero() {
  return (
    <section id="top" className="relative min-h-[100vh] flex items-center overflow-hidden bg-radial-glow">
      {/* ambient particles */}
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 md:px-10 text-center pt-24">
        <motion.h1
          ...
          className="font-display text-balance text-[2.75rem] leading-[1.05] sm:text-6xl md:text-7xl lg:text-[5.25rem] tracking-tight text-ivory"
        >
          Intelligence for
          <br />
          everyday life.
